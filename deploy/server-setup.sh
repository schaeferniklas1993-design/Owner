...
echo
echo "  JETZT NOCH – unbedingt die Startpasswörter ändern:"
echo "    sudo -u haushalt $ZIEL/.venv/bin/python $ZIEL/cli.py passwort niklas"
echo "    sudo -u haushalt $ZIEL/.venv/bin/python $ZIEL/cli.py passwort partnerin"
echo
...
echo "    sudo -u haushalt $ZIEL/.venv/bin/python $ZIEL/cli.py gehalt partnerin 2100,00"
echo "============================================================"
